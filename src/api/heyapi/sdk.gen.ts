...
import type { UploadFileData, UploadFileResponses, AddPetData, AddPetErrors, UpdatePetData, UpdatePetErrors, FindPetsByStatusData, FindPetsByStatusResponses, FindPetsByStatusErrors, FindPetsByTagsData, FindPetsByTagsResponses, FindPetsByTagsErrors, DeletePetData, DeletePetErrors, GetPetByIdData, GetPetByIdResponses, GetPetByIdErrors, UpdatePetWithFormData, UpdatePetWithFormErrors, GetInventoryData, GetInventoryResponses, PlaceOrderData, PlaceOrderResponses, PlaceOrderErrors, DeleteOrderData, DeleteOrderErrors, GetOrderByIdData, GetOrderByIdResponses, GetOrderByIdErrors, CreateUsersWithListInputData, CreateUsersWithListInputResponses, DeleteUserData, DeleteUserErrors, GetUserByNameData, GetUserByNameResponses, GetUserByNameErrors, UpdateUserData, UpdateUserErrors, LoginUserData, LoginUserResponses, LoginUserErrors, LogoutUserData, LogoutUserResponses, CreateUsersWithArrayInputData, CreateUsersWithArrayInputResponses, CreateUserData, CreateUserResponses } from './types.gen';
...
export const addPet = <ThrowOnError extends boolean = false>(options: Options<AddPetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, AddPetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updatePet = <ThrowOnError extends boolean = false>(options: Options<UpdatePetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, UpdatePetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const findPetsByStatus = <ThrowOnError extends boolean = false>(options: Options<FindPetsByStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindPetsByStatusResponses, FindPetsByStatusErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const findPetsByTags = <ThrowOnError extends boolean = false>(options: Options<FindPetsByTagsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindPetsByTagsResponses, FindPetsByTagsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const placeOrder = <ThrowOnError extends boolean = false>(options: Options<PlaceOrderData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PlaceOrderResponses, PlaceOrderErrors, ThrowOnError>({
        url: '/store/order',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const createUsersWithListInput = <ThrowOnError extends boolean = false>(options: Options<CreateUsersWithListInputData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateUsersWithListInputResponses, unknown, ThrowOnError>({
...
export const createUsersWithArrayInput = <ThrowOnError extends boolean = false>(options: Options<CreateUsersWithArrayInputData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateUsersWithArrayInputResponses, unknown, ThrowOnError>({
