...
): UseMutationOptions<unknown, DefaultError, Options<UpdatePetWithFormData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DefaultError,
...
): UseMutationOptions<unknown, DefaultError, Options<CreateUsersWithListInputData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DefaultError,
...
export const createUsersWithArrayInputQueryKey = (
  options: Options<CreateUsersWithArrayInputData>,
) => createQueryKey('createUsersWithArrayInput', options)

export const createUsersWithArrayInputOptions = (
  options: Options<CreateUsersWithArrayInputData>,
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
): UseMutationOptions<unknown, DefaultError, Options<CreateUsersWithArrayInputData>> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DefaultError,
